    ...
    <section className="py-16">
      <div className="container grid items-center gap-12 lg:grid-cols-2">
        <div>
          ...
          <p className="mt-4 text-muted-foreground">
            Make it count. Choose from beautiful layouts that put your work
            first and your brand front-and-center.
          </p>
        </div>
      ...
      <div className="container mt-16 grid items-center gap-12 lg:grid-cols-2">
        ...
        <div>
          ...
          <p className="mt-4 text-muted-foreground">
            Every template adapts seamlessly to phones, tablets, and desktops.
            Your work looks great everywhere.
          </p>
        </div>
      </div>
      <div className="container mt-16 grid items-center gap-12 lg:grid-cols-2">
        <div>
          ...
          <p className="mt-4 text-muted-foreground">
            Connect a domain, publish instantly, and keep creating. We’ll handle
            the hosting, updates, and performance.
          </p>
        </div>
        <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5">
          <img
